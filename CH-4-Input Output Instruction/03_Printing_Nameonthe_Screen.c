// Write a C Program to print own name on the Screen.
...
int main()
{
    printf("Dushyant kaushik");                // printf ek output instruction hai monitor p kuch print krta hai vhi getch ek input instruction hai jo ek character keyboard se ek baar mein leta hai
