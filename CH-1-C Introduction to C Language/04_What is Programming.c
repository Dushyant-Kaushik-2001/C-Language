...
Computer programming is a medium for us to communicate with computers.Just like we use ‘Hindi’ or ‘English’ to communicate with each other,
programming is a way for us to deliver our instructions to the computer.
-Programming Kya Hai?
Programming ek process hai jisme hum ek machine ya computer ko step-by-step instructions dete hain, jo wo samajh sake aur execute kar sake. 
Computer ek dumb machine hoti hai, jo sirf wahi kaam karti hai jo usse bola jaye.
Example:
Sochiye hum ek robot ke malik hain, aur hum chahte hain ki robot chai banaye. 
Hum use kaise samjhaenge? Humko instructions dene padenge jaise:
1. Gas on karo.
2. Paani garam karo.
3. Chai patti aur cheeni daalo.
4. Chai banne ke baad gas off karo.
Yeh hi cheez programming hai! 
Yaha instructions likhne ke liye ek language use hoti hai, aur C language un languages me se ek hai.


------------------------------------------------Computer Kaise Samajhta Hai?------------------------------------------------------------------

Computer bas 0s aur 1s (binary language) samajhta hai. 
Lekin binary me program likhna mushkil hota hai, isiliye hum ek high-level language (e.g., C) ka use karte hain jo human-friendly hai. 
Phir ek compiler us language ko binary me convert karta hai taaki computer use samajh sake.


-------------------------------------------------Programming Kaise Kaam Karti Hai?------------------------------------------------------------

Programming me hamesha 3 steps hote hain:

1. Input (Data lena): Computer se data lene ka kaam hota hai, jaise user se naam ya number input karwana.
Example: scanf se input lena.

2. Processing (Kaam karna): Input par kuch operations ya calculations karte hain.
Example: 2 numbers ka sum nikalna.

3. Output (Result dikhana): Processing ke baad result screen par dikhate hain.
Example: printf se result show karna.


----------------------------------------------Programming Real Life Me Kaha Use Hoti Hai?------------------------------------------------------

1. Banking Apps: Aapka account balance check karna, transactions karna.
2. E-Commerce Websites: Amazon pe product search karna aur payment karna.
3. Games: PUBG aur Candy Crush jaise games programming se hi bante hain.
4. Robotics: Robots ko control karna, jaise car manufacturing me kaam karte hain.
5. AI (Artificial Intelligence): Siri, Alexa, aur Google Assistant ke liye.


--------------------------------------------------------Types Of Programming-------------------------------------------------------------------

1. System Programming: Operating systems aur hardware ke close programs likhne ke liye (C kaafi use hoti hai).
2. Web Development: Websites banane ke liye (HTML, CSS, JavaScript).
3. App Development: Mobile apps banane ke liye (Java, Kotlin, Swift).
4. Game Development: Games banane ke liye (C++, Unity).
