...
x = 4 > 3 < 2;         Ans. 1
x = 3 > 4 < 2;         Ans. 1
x = 5 > 4 > 3;         Ans. 0       phle 5 > 4 ko solve krenge ismein left to right chalta hai agr dono operator ki priority same hai 5 > 4 chalega to iska result aayega 1 ab 1 > 3 bacha to iska result aayega 0
