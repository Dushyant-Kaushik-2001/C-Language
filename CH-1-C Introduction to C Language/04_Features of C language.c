...
1) Simple:
C is a simple language in the sense that it provides a structured approach (to break the problem into parts), the rich set of library 
...
It also supports the features of a high-level language. That is why it is known as mid-level language.
