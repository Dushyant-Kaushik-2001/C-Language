...
Devices like digital cameras, washing machines, and digital watches are considered types of computers,
but they are special-purpose computers rather than general-purpose computers.
...
5. We can encode any information in the form of 0s and 1s. Whether it is an audio, text, video or images,
we can convert them into series of 0s and 1s.
...
1. Data is stored in our computer, generally in hard drive. 
It is stored in files. We must have seen files in our computer.
They are audio files, video files, text files, image files, etc.

2. A file in computing is a digital container used to store data, 
such as text,images,videos,audio,programs or any other type of information. 
...
1. Software is an executable file (Extension exe is windows operating system specific, for other OS extension may differ).

2. Software is a collection of instructions, data, or programs that tell a computer how to work. 
It is intangible and serves as the bridge between the hardware of a computer system and its user. 
Software enables a computer to perform specific tasks, solve problems, or interact with other software or hardware systems.
